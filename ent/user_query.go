...
func (uq *UserQuery) loadTodos(ctx context.Context, query *TodoQuery, nodes []*User, init func(*User), assign func(*User, *Todo)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(todo.FieldID), joinT.C(user.TodosPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.TodosPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.TodosPrimaryKey[0]))
